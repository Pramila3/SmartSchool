...
@Component({
  selector: 'app-search-staffstudent',
  templateUrl: './search-staffstudent.component.html',
  styleUrls: ['./search-staffstudent.component.scss']
})
export class SearchStaffstudentComponent implements OnInit {
