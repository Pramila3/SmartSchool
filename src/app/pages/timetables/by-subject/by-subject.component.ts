...
@Component({
  ...
  styleUrls: ["./by-subject.component.scss"],
})
export class BySubjectComponent implements OnInit {
  ...
  checkedOption: string = "BySubject"; // Set the initially checked option
    ...
    this.service
      ...
      .subscribe((response) => {
        if (response.status) {
          ...
          // Call subsequent functions after getShiftList() is completed
          this.callSubsequentFunctions();
        }

        this.cdr.detectChanges();
      });
  }
  callSubsequentFunctions() {
